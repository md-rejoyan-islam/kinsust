...
const Advisors = () => {
    ...
    return (
      <section className="py-5 dark:bg-[#202c4c]  text-black dark:text-white bg-[#c8eafd] h-full px-4">
        <div className="py-5 sm:border rounded-md mx-auto border-black xl:w-[1150px] lg:px-12 md:px-28 px-4">
          <h1 className="xl:text-4xl md:text-2xl text-2xl font-bold py-2">
            Our Honourable Advisors{" "}
          </h1>
          <p className="xl:text-2xl text-lg">
            KIN is working with the guidance of a group of Honourable teachers
            of SUST
          </p>
        </div>
        <div className="my-5 rounded-md py-5 sm:border mx-auto border-black xl:w-[1150px] lg:px-12 md:px-28 px-4 grid lg:grid-cols-3 gap-5 sm:grid-cols-2">
          <div className="border rounded-md px-2 py-5 hover:bg-[#bae5fdfb] dark:hover:bg-[#11224c88]  border-black ">
            <img
              src="https://kinsust.org/wp-content/uploads/2023/01/sharmin.jpg"
          ...
          <div className="border rounded-md px-2 py-5 hover:bg-[#bae5fdfb] dark:hover:bg-[#11224c88]  border-black ">
            <img
              src="https://kinsust.org/wp-content/uploads/2023/01/amena-mam.jpg"
              className="rounded-full py-2 mx-auto w-[200px] h-[200px]"
              alt=""
            />
            <div>
              ...
              <p className="md:text-[17px]">
                Professor, Department of Social Work, <br /> Shahjalal
          ...
          <div className="border rounded-md px-2 py-5 hover:bg-[#bae5fdfb] dark:hover:bg-[#11224c88]  border-black ">
            <img
              src="https://kinsust.org/wp-content/uploads/2023/01/mohsin.png"
              className="rounded-full py-2 mx-auto w-[200px] h-[200px]"
              alt=""
            />
            <div>
          ...
          <div className="border rounded-md px-2 py-5 hover:bg-[#bae5fdfb] dark:hover:bg-[#11224c88]  border-black ">
            <img
              src="https://kinsust.org/wp-content/uploads/2023/01/mazhar.jpg"
              className="rounded-full py-2 mx-auto w-[200px] h-[200px]"
              alt=""
            />
            <div>
          ...
          <div className="border rounded-md px-2 py-5 hover:bg-[#bae5fdfb] dark:hover:bg-[#11224c88]  border-black ">
            <img
              src="https://kinsust.org/wp-content/uploads/2023/01/soyab.jpg"
              className="rounded-full py-2 mx-auto w-[200px] h-[200px]"
              alt=""
            />
            <div>
