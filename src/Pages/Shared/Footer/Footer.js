...
const Footer = () => {
    return (
      <section className="bg-black dark:bg-gray-700 ">
        <footer className="footer p-10 text-base-content xl:w-5/6 m-auto place-items-center">
          ...
          <div className="text-white place-items-center">
            <span className="footer-title text-red-600">EXPLORE</span>
          ...
          <div className="text-white place-items-center">
            ...
            <a href="tel:+8801641830969" className="">
              <svg
                ...
                strokeWidth="1.5"
                stroke="currentColor"
                class="w-6 h-6 inline-block mx-1 p-[3px]"
              >
                <path
                  strokeLinecap="round"
            ...
            <a className="" href={"mailto: abc@example.com"}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <Link className=" link link-hover  wrap flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
